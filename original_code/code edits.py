...
# being + 10 points if early, + 5 points if on time, -5 points if late. Here is the code: Final Berea Busy File"
...
class HomeworkTrackerGUI:
   ...
   def create_window(self):
       self.window.config(bg="lightblue") #found reference code from python guide https://pythonguides.com/tkinter-frame-background-color/

       title = tk.Label(self.window, text="Berea Busy Task Tracker", font=("Arial", 22), bg="lightblue")
       title.pack(pady=10)
